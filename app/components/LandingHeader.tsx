...
export function LandingHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-[1000] border-b border-[#e0e0e0] bg-[rgba(250,250,250,0.95)] backdrop-blur-[10px] px-[60px] py-5 max-md:px-[30px]" style={{ fontFamily: "var(--font-roboto-mono), 'Roboto Mono', monospace" }}>
      <div className="flex items-center justify-between">
        <Link href="/" className="inline-flex items-center gap-2 font-['Roboto_Mono',monospace] text-xl font-medium text-[#1a1a1a] no-underline hover:opacity-80 transition-opacity">
          <svg
            ...
            aria-hidden="true"
          >
            <g transform="translate(0,112) scale(0.05,-0.05)" fill="#000000" stroke="#000000" strokeWidth="12" strokeLinejoin="round">
